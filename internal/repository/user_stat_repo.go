...
// IncrFollowCount increase the number of followers
...
// IncrFollowerCount increase the number of followers
...
// GetUserStatByID Get user statistics
...
// GetUserStatByIDs Get user statistics in batches
