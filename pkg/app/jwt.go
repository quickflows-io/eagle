...
// The token content.
// iss: （Issuer）Issuer
// iat: （Issued At）Issue time, expressed as a Unix timestamp
// exp: （Expiration Time）Expiration time, expressed as a Unix timestamp
// aud: （Audience）The party that received the JWT
// sub: （Subject）The subject of the JWT
// nbf: （Not Before）no earlier than this time
// jti: （JWT ID）Unique ID used to identify the JWT
